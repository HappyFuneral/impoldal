	...
	return (
		<PlayerContainer>
			<TimeControlContainer>
				<P className="text-white" >{getTime(songInfo.currentTime || 0)}</P>
				...
				<P className="text-white">{getTime(songInfo.duration || 0)}</P>
			</TimeControlContainer>

			<PlayControlContainer>
				<FontAwesomeIcon
					onClick={() => skipTrackHandler("skip-back")}
					className="text-white skip-back"
					icon={faAngleLeft}
					size="2x"
					style={pointer}
				/>
				...
				<FontAwesomeIcon
					...
					className="text-white skip-forward"
					icon={faAngleRight}
					size="2x"
					style={pointer}
				/>
